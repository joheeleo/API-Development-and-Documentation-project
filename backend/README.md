...
$ flask run
```
- `python3 -m venv env` will create the virtual environment
- `source env/bin/activate` will activate the virtual environment and export the envirnment variables needed
